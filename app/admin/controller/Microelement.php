...
use app\common\service\MicroelementService;

class Microelement extends Admin
{
    ...
    public function index()
    {
        if (!$this->request->isAjax()) {
            ...
            try {
                $field='*';
                $res = MicroelementService::loadList($where, $field, $limit, $orderby);
            } catch (\Exception $e) {
                exit($e->getMessage());
            }
            $list = $res['list'];
    ...
    public function add()
    {
        if (!$this->request->isPost()) {
            ...
            $data = input('post.');
            try {
                $res = MicroelementService::saveData('add', $data);
            } catch (\Exception $e) {
    ...
    public function update()
    {
        if (!$this->request->isPost()) {
            ...
            $info = model('Microelement')->getInfo($frament_id);
            ...
            $data = input('post.');
            try {
                $res = MicroelementService::saveData('edit', $data);
            } catch (\Exception $e) {
                $this->error($e->getMessage());
            }
    ...
    public function delete()
    {
        ...
        try {
            ...
            $res = MicroelementService::delete($where);
        } catch (\Exception $e) {
