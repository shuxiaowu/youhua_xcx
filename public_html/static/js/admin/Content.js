...
CodeInfoDlg.collectData = function () {
	this.set('content_id').set('title').set('tag').set('section1').set('section2').set('section3').set('weixin').set('class_name').set('class_id').set('pic').set('content').set('video_url').set('jumpurl').set('create_time').set('keyword').set('description').set('views').set('sortid').set('author');
};
...
CodeInfoDlg.add = function () {
	...
	var entend = new $ax(Feng.ctxPath + "/Content/getExtends", function (data) {
