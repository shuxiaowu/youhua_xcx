<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"/www/web/edg_leteng_net/public_html/../app/admin/view/content/index.html";i:1573110685;s:61:"/www/web/edg_leteng_net/app/admin/view/common/_container.html";i:1571731694;}*/ ?>
<!DOCTYPE html>
<html>
				...
				<div class="row row-lg">
					<div class="col-sm-12">
						...
						<div id="CodeGoodsTableToolbar" role="group">
							...
							<?php endif; if(in_array('/admin/Content/delete',session('admin.nodes')) ||
							session('admin.role') == 1): ?>
