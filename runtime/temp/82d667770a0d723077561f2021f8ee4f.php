<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"/www/web/edg_leteng_net/public_html/../app/admin/view/member/index.html";i:1573280983;s:61:"/www/web/edg_leteng_net/app/admin/view/common/_container.html";i:1571731694;}*/ ?>
<!DOCTYPE html>
<html>
				...
				<div class="row row-lg">
					<div class="col-sm-12">
						...
						<div id="CodeGoodsTableToolbar" role="group">
							<?php if(in_array('/admin/Member/add',session('admin.nodes')) ||
							session('admin.role') == 1): ?>
							<button type="button" id="add" class="btn btn-primary button-margin"
								onclick="CodeGoods.add()">
								<i class="fa fa-plus"></i>&nbsp;添加
							</button>
							<?php endif; if(in_array('/admin/Member/update',session('admin.nodes')) ||
							session('admin.role') == 1): ?>
							<button type="button" id="update" class="btn btn-primary button-margin"
								onclick="CodeGoods.update()">
								<i class="fa fa-edit"></i>&nbsp;修改
							</button>
							<?php endif; if(in_array('/admin/Member/recharge',session('admin.nodes')) ||
							session('admin.role') == 1): ?>
							<button type="button" id="recharge" class="btn btn-warning button-margin"
								onclick="CodeGoods.recharge()">
								<i class="fa fa-edit"></i>&nbsp;充值
							</button>
							<?php endif; ?>
							<!-- <?php if(in_array('/admin/Member/backRecharge',session('admin.nodes')) ||
							session('admin.role') == 1): ?>
							<button type="button" id="backRecharge" class="btn btn-warning button-margin"
								onclick="CodeGoods.backRecharge()">
								<i class="fa fa-edit"></i>&nbsp;回收
							</button>
							<?php endif; ?> -->
							<?php if(in_array('/admin/Member/delete',session('admin.nodes')) ||
							session('admin.role') == 1): ?>
							...
							<?php endif; ?>
							<!-- <?php if(in_array('/admin/Member/forbidden',session('admin.nodes')) ||
							session('admin.role') == 1): ?>
							...
							<?php endif; if(in_array('/admin/Member/start',session('admin.nodes')) ||
							session('admin.role') == 1): ?>
							...
							<?php endif; ?> -->
<!-- 
							<?php if(in_array('/admin/Member/updatePassword',session('admin.nodes')) ||
							session('admin.role') == 1): ?>
							<button type="button" id="updatePassword" class="btn btn-primary button-margin"
								onclick="CodeGoods.updatePassword()">
								<i class="fa fa-lock"></i>&nbsp;重置密码
							</button>
							<?php endif; ?> -->
							<!-- <?php if(in_array('/admin/Member/batchUpdate',session('admin.nodes')) ||
							session('admin.role') == 1): ?>
							<button type="button" id="batchUpdate" class="btn btn-primary button-margin"
								onclick="CodeGoods.batchUpdate()">
								<i class="fa fa-edit"></i>&nbsp;批量修改
							</button>
							<?php endif; ?> -->

							<?php if(in_array('/admin/Member/viewMember',session('admin.nodes')) ||
							session('admin.role') == 1): ?>
...
<script>
	...
	CodeGoods.initColumn = function () {
		return [
			...
			{ title: '生日', field: 'birth', visible: true, align: 'center', valign: 'middle' },
			...
			// { title: '姓名', field: 'relname', visible: false, align: 'center', valign: 'middle' },
			...
			// { title: '省市区', field: 'province|city|district', visible: false, align: 'center', valign: 'middle', formatter: 'CodeGoods.threeAreaFormatter' },
			// { title: '色值', field: 'color', visible: false, align: 'center', valign: 'middle' },
