<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"/www/web/edg_leteng_net/public_html/../app/admin/view/login/index.html";i:1571879992;}*/ ?>
<!DOCTYPE HTML>
<html>
...
<body>
	<div id="loginTopBar" class="tips_3 mt_5">友情提示：为保证后台账号安全，建议在不使用后台时 <span class=font_red>关闭浏览器</span> 或者 点击后台的 <span
			class=font_red>退出</span> 按钮。</div>
		...
		<div class="section_right">
			<div class="bg0">
				...
				<dl class="loginF">
					...
					<dd class="f"><input name="verify" id="averfiy" type="text" class="field_t2"><img
							src="/admin/Login/Verify" onClick="this.src=this.src+'?'+Math.random()" alt="点击刷新验证码"
							id="img" style=" margin-left:10px; cursor:pointer"></dd>
					<dt class="b"><input name="提交" id="submit" type="button" onClick="login()" class="btn_login0"
							value="登录">&nbsp;&nbsp;<input name="重置" type="reset" class="btn_login1" onclick="reset()"
							value="重置"></dt>
				</dl>
			</div>
		</div>
