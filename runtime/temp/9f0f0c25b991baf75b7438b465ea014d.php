<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"/www/web/edg_leteng_net/public_html/../app/admin/view/field/index.html";i:1570457892;s:61:"/www/web/edg_leteng_net/app/admin/view/common/_container.html";i:1571731694;}*/ ?>
<!DOCTYPE html>
<html>
...
<script>
	...
	CodeGoods.add = function () {
		var index = layer.open({type: 2,title: '添加字段',area: ['100%', '100%'],fix: false, maxmin: true,content: Feng.ctxPath + '/Field/add/extend_id/<?php echo $extend_id; ?>'});
	...
	$(function() {
		...
		var table = new BSTable(CodeGoods.id, Feng.ctxPath + "/Field/index/extend_id/<?php echo $extend_id; ?>",defaultColunms);
